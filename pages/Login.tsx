    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 bg-slate-50/50">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-2xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-500 font-medium">Access your farm intelligence from any device</p>
        </div>
          ...
          <div className="bg-emerald-50/50 p-6 rounded-2xl border border-emerald-50">
            <div className="flex gap-4 items-start">
              ...
              <p className="text-xs text-slate-600 leading-relaxed font-medium">
                Agricare uses high-security Google Authentication to protect your field telemetry and AI prescriptions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center pt-4">
          <p className="text-sm text-slate-400">
            ...
            <button className="font-bold text-slate-600 hover:text-emerald-600">Privacy Policy</button>
          </p>
        </div>
      </div>
    </div>
